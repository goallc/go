...
// LLVM-DAG: define goabiinternal i8 @codegen.zeroExtArgUint16(ptr preallocated([2 x i16])
// LLVM-DAG: zext i16 {{%.*}} to i64
// LLVM-DAG: icmp ult i64 {{%.*}}, 256
// LLVM-DAG: getelementptr i8, ptr @codegen.wsp, i64
// LLVM-DAG: define goabiinternal i8 @codegen.zeroExtArgByte(ptr preallocated([2 x i8])
