...
func (lfc *LLVMFuncContext) lowerGeneratedSIMD(v *Value) (llvm.Value, bool) {
	...
	case goALLCSIMDLowerSHA1Rounds, goALLCSIMDLowerSHA1NextE, goALLCSIMDLowerSHA1Message1, goALLCSIMDLowerSHA1Message2, goALLCSIMDLowerSHA256Rounds, goALLCSIMDLowerSHA256Message1, goALLCSIMDLowerSHA256Message2:
		return finish(lfc.simdSHA(v, info.lowering))
...
func (lfc *LLVMFuncContext) genLV(v *Value, restoreBuilder bool) llvm.Value {
	...
	case OpStoreWB:
		...
		sig := llvm.FunctionType(GlobalCtxt.VoidType(), []llvm.Type{value.Type(), address.Type(), GlobalCtxt.Int32Type()}, false)
		...
		record := lfc.b.CreateCall(sig, fn, []llvm.Value{value, address, flags}, "")
