...
func goALLCSIMDOpLiteral(encoded string) string {
	...
	lowering := goALLCSIMDConst("lowering", d.Lowering, map[string]string{
		...
		"scale":      "goALLCSIMDLowerScale",
		"reciprocal": "goALLCSIMDLowerReciprocal", "reciprocal-sqrt": "goALLCSIMDLowerReciprocalSqrt",
		...
		"carryless-mul-widen-low": "goALLCSIMDLowerCarrylessMulWidenLow",
		"carryless-mul":           "goALLCSIMDLowerCarrylessMul",
		...
		"sha1-rounds": "goALLCSIMDLowerSHA1Rounds", "sha1-next-e": "goALLCSIMDLowerSHA1NextE",
		"sha1-message1": "goALLCSIMDLowerSHA1Message1", "sha1-message2": "goALLCSIMDLowerSHA1Message2",
		"sha256-rounds": "goALLCSIMDLowerSHA256Rounds", "sha256-message1": "goALLCSIMDLowerSHA256Message1", "sha256-message2": "goALLCSIMDLowerSHA256Message2",
		"mul-add-integer":   "goALLCSIMDLowerMulAddInteger",
		"pair-add":          "goALLCSIMDLowerPairAdd",
		"dot-pairs":         "goALLCSIMDLowerDotPairs",
		"rotate-left":       "goALLCSIMDLowerRotateLeft",
		"rotate-right":      "goALLCSIMDLowerRotateRight",
		"funnel-left":       "goALLCSIMDLowerFunnelLeft",
		"funnel-right":      "goALLCSIMDLowerFunnelRight",
		"funnel-all-left":   "goALLCSIMDLowerFunnelAllLeft",
		"funnel-all-right":  "goALLCSIMDLowerFunnelAllRight",
		"dot-pairs-us-sat":  "goALLCSIMDLowerDotPairsUSSat",
		"sum-8-abs-diff":    "goALLCSIMDLowerSum8AbsDiff",
		"pair-sub":          "goALLCSIMDLowerPairSub",
		"pair-add-128":      "goALLCSIMDLowerPairAdd128",
		"pair-sub-128":      "goALLCSIMDLowerPairSub128",
		"pair-sadd-sat":     "goALLCSIMDLowerPairSAddSat",
		"pair-ssub-sat":     "goALLCSIMDLowerPairSSubSat",
		"pair-sadd-sat-128": "goALLCSIMDLowerPairSAddSat128",
		"pair-ssub-sat-128": "goALLCSIMDLowerPairSSubSat128",
		"add-odd-sub-even":  "goALLCSIMDLowerAddOddSubEven",
		"fma":               "goALLCSIMDLowerFMA", "fma-add-even": "goALLCSIMDLowerFMAAddEven", "fma-add-odd": "goALLCSIMDLowerFMAAddOdd",
		...
		"permute-32-128":         "goALLCSIMDLowerPermute32_128",
		"permute":                "goALLCSIMDLowerPermute",
		"concat-permute":         "goALLCSIMDLowerConcatPermute",
		"lookup-or-zero":         "goALLCSIMDLowerLookupOrZero",
		"permute-or-zero":        "goALLCSIMDLowerPermuteOrZero",
		"permute-or-zero-128":    "goALLCSIMDLowerPermuteOrZero128",
		"permute-low-16-128":     "goALLCSIMDLowerPermuteLow16_128",
		"permute-high-16-128":    "goALLCSIMDLowerPermuteHigh16_128",
		"concat-select-128":      "goALLCSIMDLowerConcatSelect128",
		"concat-permute-128":     "goALLCSIMDLowerConcatPermute128",
		"concat-shift-bytes-128": "goALLCSIMDLowerConcatShiftBytes128",
		"shift-all-left":         "goALLCSIMDLowerShiftAllLeft",
		...
		"set-high":               "goALLCSIMDLowerSetHigh",
		"broadcast-low":          "goALLCSIMDLowerBroadcastLow",
		"interleave-low":         "goALLCSIMDLowerInterleaveLow",
		"interleave-high":        "goALLCSIMDLowerInterleaveHigh",
		"interleave-low-128":     "goALLCSIMDLowerInterleaveLow128",
		"interleave-high-128":    "goALLCSIMDLowerInterleaveHigh128",
		"concat-even":            "goALLCSIMDLowerConcatEven",
		"concat-odd":             "goALLCSIMDLowerConcatOdd",
		"interleave-even":        "goALLCSIMDLowerInterleaveEven",
		"interleave-odd":         "goALLCSIMDLowerInterleaveOdd",
	})
